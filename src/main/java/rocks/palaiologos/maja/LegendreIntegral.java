...
class LegendreIntegral {
    ...
    public static double legendreF(double phi, double k) {
        return integrateTanhSinhReal(t ->
    ...
    public static Complex legendreF(Complex phi, Complex k) {
        return integrateTanhSinhComplex(t -> div(1, mul(sqrt(sub(1, mul(t, t))), sqrt(sub(1, mul(mul(k, k), mul(t, t)))))), Complex.ZERO, sin(phi), 6, 1e-10)[0];
    }

    public static Complex legendreE(Complex phi, Complex k) {
        return integrateTanhSinhComplex(t -> div(sqrt(sub(1, mul(mul(k, k), mul(t, t)))), sqrt(sub(1, mul(t, t)))), Complex.ZERO, sin(phi), 6, 1e-10)[0];
    }
    ...
    public static Complex legendrePi(Complex phi, Complex alpha, Complex k) {
        return integrateTanhSinhComplex(t -> div(1, mul(sqrt(sub(1, mul(t, t))), mul(sqrt(sub(1, mul(mul(k, k), mul(t, t)))), sub(1, mul(alpha, mul(t, t)))))), Complex.ZERO, sin(phi), 6, 1e-10)[0];
    }
}
